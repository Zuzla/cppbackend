...
StringResponse HandleRequest(StringRequest&& req) 
{
    ...
    case http::verb::get:
	{
        ...
        return MakeStringResponse(http::status::ok, "Hello, "s.append(target), req.version(), req.keep_alive());
	}
        break;
    case http::verb::head:
    {
    ...
    default:
    {
        return MakeStringResponse(http::status::method_not_allowed, "Invalid method"sv, req.version(), req.keep_alive());
    }
        break;
    }
